...
namespace PdfPoc.Helpers.PrinterHelper
{
    /// <summary>
    ...
    class DisablePreviewPrintHelper : PrintHelper
    {
        ...
        public DisablePreviewPrintHelper() : base()
        {
        ...
        protected RichTextBlockOverflow AddOnePrintPage(RichTextBlockOverflow lastRTBOAdded, PrintPageDescription printPageDescription)
        {
            ...
            double marginWidth = Math.Max(printPageDescription.PageSize.Width - printPageDescription.ImageableRect.Width, printPageDescription.PageSize.Width * 2);
            double marginHeight = Math.Max(printPageDescription.PageSize.Height - printPageDescription.ImageableRect.Height, printPageDescription.PageSize.Height * 2);
